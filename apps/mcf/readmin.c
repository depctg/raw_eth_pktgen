...
*/
    ...
    net->dummy_arcs = (arc_t *) _disagg_alloc(2, sizeof(arc_t) * net->n);
    net->arcs = (arc_t *) _disagg_alloc(2, sizeof(arc_t) * (32ULL << 20));
    ...
    */
    ...
    for( i = 1; i <= net->n_trips; i++ )
    {
        ...
        r_arc = cache_access_mod_opt_mut(arc);                    
    ...
    for( i = 1; i <= net->n_trips; i++ )
    {
        arc_t *r_arc3i1 = cache_access_mod_opt_mut(&net->arcs[3*i-1]);
        r_arc3i1->cost = 
