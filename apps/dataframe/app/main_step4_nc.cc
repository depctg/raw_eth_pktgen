...
const size_t s4_nb = 512 * 1024;
const size_t s4_n_block = 157;

// total 30 GB -> local X * 30
rring_init(rvid,       int,        s4_nb * sizeof(int),        s4_n_block, 0, 8192);
// rring_init(rpickdate,  SimpleTime, s4_nb * sizeof(SimpleTime), s4_n_block, 0, 8192 + (1ULL << 30));
// rring_init(rdropdate,  SimpleTime, s4_nb * sizeof(SimpleTime), s4_n_block, 0, 8192 + (2ULL << 30));
// rring_init(rpsgcnt,    int,        s4_nb * sizeof(int),        s4_n_block, 0, 8192 + (3ULL << 30));
// rring_init(rtripdist,  double,     s4_nb * sizeof(double),     s4_n_block, 0, 8192 + (4ULL << 30));
// rring_init(rplon,      double,     s4_nb * sizeof(double),     s4_n_block, 0, 8192 + (5ULL << 30));
// rring_init(rplat,      double,     s4_nb * sizeof(double),     s4_n_block, 0, 8192 + (6ULL << 30));
// rring_init(rrateid,    int,        s4_nb * sizeof(int),        s4_n_block, 0, 8192 + (7ULL << 30));
rring_init(rflag,      char,       s4_nb * sizeof(char),       s4_n_block, 0, 8192 + (8ULL << 30));
// rring_init(rdlon,      double,     s4_nb * sizeof(double),     s4_n_block, 0, 8192 + (9ULL << 30));
// rring_init(rdlat,      double,     s4_nb * sizeof(double),     s4_n_block, 0, 8192 + (10ULL << 30));
// rring_init(rptype,     int,        s4_nb * sizeof(int),        s4_n_block, 0, 8192 + (11ULL << 30));
// rring_init(rfare,      double,     s4_nb * sizeof(double),     s4_n_block, 0, 8192 + (12ULL << 30));
// rring_init(rextra,     double,     s4_nb * sizeof(double),     s4_n_block, 0, 8192 + (13ULL << 30));
// rring_init(rmta,       double,     s4_nb * sizeof(double),     s4_n_block, 0, 8192 + (14ULL << 30));
// rring_init(rtip,       double,     s4_nb * sizeof(double),     s4_n_block, 0, 8192 + (15ULL << 30));
// rring_init(rtolls,     double,     s4_nb * sizeof(double),     s4_n_block, 0, 8192 + (16ULL << 30));
// rring_init(rimpv,      double,     s4_nb * sizeof(double),     s4_n_block, 0, 8192 + (17ULL << 30));
// rring_init(rtotal,     double,     s4_nb * sizeof(double),     s4_n_block, 0, 8192 + (18ULL << 30));
rring_init(rids,       size_t,     s4_nb * sizeof(size_t),     s4_n_block, 0, 8192 + (19ULL << 30));
